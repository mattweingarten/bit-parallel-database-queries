...
//TODO
        ...
        */
        ...
        for(int m = 0; m < samples_per_block; m++){
            // first 64 bit block
            results[ri0] = cres0 & 1;
            //todo handle different amount of features
            csumtemp = csum0 & 4294967295;
            if ((cres0 & 1) == 1){
                //todo mask csum0
                sum+= csumtemp;
            }
