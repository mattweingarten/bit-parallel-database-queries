...
plt.plot(x,df['parallel'],linestyle="dashed",color="navajowhite",marker="*",label="parallel")
plt.plot(x,df['vector'],linestyle="dashed",color="plum",marker="+",label="vector")
plt.plot(x,df['unroll4x'],linestyle="dashed",color="darksalmon",marker="D",label="unroll4x")
plt.plot(x,df['0check'],linestyle="dashed",color="peru",marker="2",label="zero check")
plt.plot(x,df['earlypruneand0check'],linestyle="dashed",color="olive",marker="h",label="zero check & early prune")
