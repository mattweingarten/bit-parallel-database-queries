...
typedef void (*q1_t) (uint32_t * data,uint32_t * results,uint32_t *temps,int64_t *comp_cycles,int64_t *res_cycles,int num_samples,int num_features ,int number_entries);
